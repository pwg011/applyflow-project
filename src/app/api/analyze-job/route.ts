  ...
  try {
    ...
    const systemPrompt = isImprovementMode
      ? [
          ...
          "For job_location, job_deadline, job_benefits, and application_instructions, extract information when it is expressly stated or reasonably supported by the job posting.",
          "Do not return null merely because the information is not presented under a formal heading.",
          "Use the full job posting context, including title, body, eligibility section, duties, rewards, application section, and metadata.",
          "Return null only when the job posting provides no reliable basis for that field.",
          "Do not invent facts outside the job posting.",
          "job_location: Capture the role's work location or work arrangement where the posting provides a reliable basis for it. Consider geographic references, work arrangement language, eligibility location restrictions, office references, and other location-related context. If the posting gives only a company location, use it only when the context reasonably connects it to the role.",
          "job_deadline: Capture the deadline, closing date, expiry date, submission date, or any time limit for applying where the posting provides one. Consider both formal deadline sections and deadline language embedded anywhere in the posting. If the posting gives dates that are unrelated to application submission, do not treat them as the deadline.",
          "job_benefits: Capture the rewards, advantages, training value, compensation, development opportunity, employment pathway, work exposure, support, or other benefits offered to applicants. Benefits may be described directly or embedded in the programme or job description. Do not include ordinary duties or requirements as benefits.",
          "application_instructions: Capture the method, process, channel, documents, steps, or conditions for applying where the posting provides them. Consider application sections, eligibility and application process text, submission guidance, links, contact channels, and procedural instructions. Do not invent application steps not supported by the posting.",
          "For job_skills:",
          ...
          "Return null only when the job posting provides no reliable basis for the field.",
        ].join(" ")
      : [
