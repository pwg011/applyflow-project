export default function NewTemplateCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex min-h-[170px] w-full flex-col items-center justify-center rounded-lg border border-dashed border-[#cfd2d6] bg-white/35 px-6 py-6 text-center text-[#4b4b4d] shadow-[0_12px_26px_rgba(0,0,0,0.025)] transition hover:border-[#bfc2c6] hover:bg-white/55"
    >
